...
fun ExplainScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.explain)) },
                navigationIcon = {
        ...
        Box(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        val file = File(dir, "explain_${System.currentTimeMillis()}.jpg")
            ...
            Text(stringResource(R.string.text_to_explain), style = MaterialTheme.typography.titleSmall)
            if (uiState.imageUri != null && !uiState.isExtractingFromImage) {
                Text(
                    stringResource(R.string.text_from_image_hint),
                    style = MaterialTheme.typography.bodySmall,
            ...
            Button(
                ...
                Text(if (uiState.isLoading) "…" else stringResource(R.string.explain_button))
            }
