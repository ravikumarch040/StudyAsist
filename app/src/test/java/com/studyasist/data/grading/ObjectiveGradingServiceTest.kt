...
class ObjectiveGradingServiceTest {
    ...
    @Test
    fun `MCQ - exact match gives full credit`() {
    ...
    @Test
    fun `MCQ - option letter match gives full credit`() {
    ...
    @Test
    fun `MCQ - wrong answer gives zero`() {
    ...
    @Test
    fun `TrueFalse - true match gives full credit`() {
    ...
    @Test
    fun `TrueFalse - yes matches true`() {
        val qa = qa(1L, "T or F?", "True", QuestionType.TRUE_FALSE)
    ...
    @Test
    fun `TrueFalse - false when model is true gives zero`() {
        val qa = qa(1L, "T or F?", "True", QuestionType.TRUE_FALSE)
    ...
    @Test
    fun `Numeric - exact match gives full credit`() {
    ...
    @Test
    fun `Numeric - tolerance within 0_01 gives full credit`() {
    ...
    @Test
    fun `Numeric - outside tolerance gives zero`() {
        val qa = qa(1L, "Value?", "3.14", QuestionType.NUMERIC)
    ...
    @Test
    fun `Short - exact match gives full credit`() {
    ...
    @Test
    fun `Short - case insensitive match gives full credit`() {
    ...
    @Test
    fun `Short - high token overlap gives full credit`() {
    ...
    @Test
    fun `Short - low overlap gives zero`() {
    ...
    @Test
    fun `Short - medium overlap gives partial credit`() {
    ...
    @Test
    fun `unknown QA id skips that answer`() {
        val qa = qa(1L, "Q?", "Paris", QuestionType.SHORT)
    ...
    @Test
    fun `multiple questions aggregate score`() {
